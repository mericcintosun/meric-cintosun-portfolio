...
const translations = {
  en: {
    ...
    softitoDesc: "320-hour mobile development program: 140h Dart, 180h Flutter. Built cross-platform apps with Firebase, REST API, and state management.",
    
    ituTitle: "ITU Blockchain",
    ituSubtitle: "Developer",
    ituDate: "June 2023 – Present",
    ituDesc: "Developed award-winning dApps using Next.js, Web3.js, MongoDB. Created technical reports and contributed to research on blockchain.",
    
    medyanesTitle: "Medyanes 360",
    medyanesSubtitle: "Tech Lead",
    medyanesDate: "November 2024 – May 2025",
    medyanesDesc: "Led sprints, code reviews, and team coordination using Agile/JIRA. Boosted team efficiency through mentoring and daily standups.",
    
    flalingoTitle: "Flalingo",
    flalingoSubtitle: "Mid Frontend & Mobile Developer",
    flalingoDate: "November 2024 – March 2025",
    flalingoDesc: "Enhanced AI-powered mobile app with React Native + Expo. Updated website UI/UX; debugged and maintained performance. Collaborated with design and product teams across time zones. | USA - California",
    
    viviencyTitle: "Viviency Digital Media Agency",
    viviencySubtitle: "Full Stack Developer",
    viviencyDate: "January 2024 - October 2024",
    viviencyDesc: "Built SEO-optimized websites using WordPress (Headless), Next.js. Delivered client-ready websites and technical consulting.",
  ...
  tr: {
    ...
    softitoDesc: "320 saatlik mobil geliştirme programı: 140s Dart, 180s Flutter. Firebase, REST API ve state management ile çapraz platform uygulamaları geliştirdim.",
    
    ituTitle: "İTÜ Blockchain",
    ituSubtitle: "Geliştirici",
    ituDate: "Haziran 2023 – Günümüz",
    ituDesc: "Next.js, Web3.js, MongoDB kullanarak ödüllü dApps geliştirdim. Teknik raporlar oluşturdum ve blockchain araştırmalarına katkıda bulundum.",
    
    medyanesTitle: "Medyanes 360",
    medyanesSubtitle: "Teknoloji Lideri",
    medyanesDate: "Kasım 2024 – Mayıs 2025",
    medyanesDesc: "Agile/JIRA kullanarak sprintleri, kod incelemelerini ve takım koordinasyonunu yönettim. Mentorluk ve günlük standup'lar ile takım verimliliğini artırdım.",
    
    flalingoTitle: "Flalingo",
    flalingoSubtitle: "Mid Frontend & Mobil Geliştirici",
    flalingoDate: "Kasım 2024 – Mart 2025",
    flalingoDesc: "React Native + Expo ile AI destekli mobil uygulamayı geliştirdim. Website UI/UX güncelledim; hata ayıklama ve performans bakımı yaptım. Zaman dilimi farklılıklarıyla tasarım ve ürün ekipleriyle işbirliği yaptım. | ABD - California",
    
    viviencyTitle: "Viviency Dijital Medya Ajansı",
    viviencySubtitle: "Full Stack Geliştirici",
    viviencyDate: "Ocak 2024 - Ekim 2024",
    viviencyDesc: "WordPress (Headless), Next.js kullanarak SEO optimize edilmiş web siteleri oluşturdum. Müşteriye hazır web siteleri ve teknik danışmanlık hizmeti sundum.",
